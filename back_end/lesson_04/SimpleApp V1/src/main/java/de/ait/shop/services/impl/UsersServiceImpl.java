...
public class UsersServiceImpl implements UsersService {
    ...
    @Autowired
    public UsersServiceImpl(UsersRepository usersRepositoryFile,
                            EmailValidator emailValidatorRegex,
                            PasswordValidator passwordValidatorRegex) {
        this.usersRepository = usersRepositoryFile;
        this.emailValidator = emailValidatorRegex;
        this.passwordValidator = passwordValidatorRegex;
    }
